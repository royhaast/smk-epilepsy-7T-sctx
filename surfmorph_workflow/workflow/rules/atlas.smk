...
rule subject_space_to_vtk:
   ...
   output: 'deriv/postsurfmorph_{atlas}/sub-{subject}_{hemi}/sub-{subject}_hemi-{hemi}_space-T1w_label-{roi}.vtk'
...
rule left_atlas_to_nifti:
    ...
    output: 'deriv/atlas_{atlas}/sub-{subject}/sub-{subject}_hemi-L_atlas.nii.gz'
    group: 'atlas_participant'
    shell:
        """
...
rule right_atlas_to_nifti:
    input: unpack(define_thomas_input)
    output: 'deriv/atlas_{atlas}/sub-{subject}/sub-{subject}_hemi-R_atlas.nii.gz'
    group: 'atlas_participant'
    shell:
        """
...
rule atlas_dilate:
    input: 'deriv/atlas_{atlas}/sub-{subject}/sub-{subject}_hemi-{hemi}_atlas.nii.gz'
    output: 'deriv/atlas_{atlas}/sub-{subject}/sub-{subject}_hemi-{hemi}_atlas_dilated-5mm.nii.gz'
    group: 'atlas_participant'    
...
rule atlas_to_surf:
    input: 
        surf = 'deriv/postsurfmorph_{atlas}/sub-{subject}_{hemi}/sub-{subject}_hemi-{hemi}_space-T1w_label-{roi}.vtk',
        atlas = 'deriv/atlas_{atlas}/sub-{subject}/sub-{subject}_hemi-{hemi}_atlas_dilated-5mm.nii.gz'
    output: 'deriv/atlas_{atlas}/sub-{subject}/sub-{subject}_hemi-{hemi}_label-{roi}_atlas.shape.gii'
    group: 'atlas_participant'    
    script: '../scripts/atlas_to_gifti.py'

rule gen_atlas_gii:
    input: expand('deriv/atlas_{atlas}/sub-{subject}/sub-{subject}_hemi-{hemi}_label-{{roi}}_atlas.shape.gii', atlas=config['atlas'], subject=subjects, hemi=['R'])
    output: 'deriv/atlas_{atlas}/sub-all/sub-all_label-{roi}_atlas.shape.gii'
    params:
...
rule get_atlas_label:
    input:
        gii = 'deriv/atlas_{atlas}/sub-all/sub-all_label-{roi}_atlas.shape.gii',
    output: 'deriv/atlas_{atlas}/sub-all/sub-all_label-{roi}_atlas.label.gii'
    params:
...
rule get_atlas_border:
    input:
        surf = expand('deriv/postsurfmorph_{atlas}/sub-{subject}_R/sub-{subject}_hemi-R_space-T1w_label-{{roi}}.surf.gii', atlas=config['atlas'], subject=subjects[0]),
        label = 'deriv/atlas_{atlas}/sub-all/sub-all_label-{roi}_atlas.label.gii',
    output: 'deriv/atlas_{atlas}/sub-all/sub-all_label-{roi}_atlas.border'
    group: 'atlas_group'
    shell:
        """
...
rule summarize_shape_per_nuclei_ami:
    input:
        atlas = 'deriv/atlas_ami/sub-all/sub-all_label-{roi}_atlas.label.gii',
        metrics = expand(
            'deriv/postsurfmorph_ami/sub-{{subject}}_{hemi}/sub-{{subject}}_hemi-{hemi}_label-{{roi}}_{metrics}-smoothed.shape.gii',
...
rule summarize_shape_per_nuclei_thomas:
    input:
        atlas = 'deriv/atlas_thomas/sub-all/sub-all_label-thalamus_atlas.shape.gii',
        metrics = expand(
            'deriv/postsurfmorph_thomas/sub-{{subject}}_{hemi}/sub-{{subject}}_hemi-{hemi}_label-thalamus_{metrics}-smoothed.shape.gii',
            hemi=['L','R'], metrics=['displacement','area','curvature'])
    params:
        subject_info = 'resources/subjects_displacement.csv',
